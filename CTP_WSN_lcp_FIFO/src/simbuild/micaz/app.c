...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2abe1ec38cf8, const void *arg_0x2abe1ec37020);
#line 775
...
#line 250
extern double erfc(double arg_0x2abe1ecb8618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2abe1eefa8e8), 
int (*key_eq_fn)(void *arg_0x2abe1eef90c8, void *arg_0x2abe1eef9368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2abe1f10a610, int arg_0x2abe1f10a878);
static double RandomUniform(void );
...
collection_id_t arg_0x2abe1f9cc9b0, 
...
collection_id_t arg_0x2abe1f9cde08, 
# 71 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
collection_id_t arg_0x2abe1f9cd270, 
# 71 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
static uint8_t /*CtpP.Router*/CtpRoutingEngineP$0$routingTableFind(am_addr_t arg_0x2abe2001b060);
static inline error_t /*CtpP.Router*/CtpRoutingEngineP$0$routingTableUpdateEntry(am_addr_t arg_0x2abe2001b968, am_addr_t arg_0x2abe2001bc30, uint16_t arg_0x2abe20019020);
...
#line 737
  ...
  if (CtpWsnC$csNum[sim_node()] >= CSMAX) {
      for (CtpWsnC$i[sim_node()] = 0; CtpWsnC$i[sim_node()] < CSMAX - 1; CtpWsnC$i[sim_node()]) {
          memcpy(&CtpWsnC$csTable[sim_node()][CtpWsnC$i[sim_node()]], &CtpWsnC$csTable[sim_node()][CtpWsnC$i[sim_node()] + 1], sizeof(csIt ));
          CtpWsnC$csTable[sim_node()][CtpWsnC$i[sim_node()]].data = CtpWsnC$csTable[sim_node()][CtpWsnC$i[sim_node()] + 1].data;
          CtpWsnC$csTable[sim_node()][CtpWsnC$i[sim_node()]].weight = CtpWsnC$csTable[sim_node()][CtpWsnC$i[sim_node()] + 1].weight;
        }
      memset(&CtpWsnC$csTable[sim_node()][CSMAX - 1], 0, sizeof(csIt ));
      memcpy(& CtpWsnC$csTable[sim_node()][CSMAX - 1].csName, & ndwRec->msgName, sizeof(name ));
      CtpWsnC$csTable[sim_node()][CSMAX - 1].data = ndwRec->data;
      CtpWsnC$csTable[sim_node()][CSMAX - 1].weight = 3;
    }
#line 810
  return FALSE;
}
      ...
      ability_equal(Rec->msgName.ability, CtpWsnC$csTable[sim_node()][CtpWsnC$i[sim_node()]].csName.ability)
       || location_belong(CtpWsnC$csTable[sim_node()][CtpWsnC$i[sim_node()]].csName.ability, Rec->msgName.ability)) {
          ...
          if (CtpWsnC$type1[sim_node()] == CtpWsnC$type0[sim_node()]) {
              ...
              for (CtpWsnC$j[sim_node()] = CtpWsnC$i[sim_node()]; CtpWsnC$j[sim_node()] > 0; CtpWsnC$j[sim_node()]--) 
                {
                  memcpy(& CtpWsnC$csTable[sim_node()][CtpWsnC$j[sim_node()]].csName, & CtpWsnC$csTable[sim_node()][CtpWsnC$j[sim_node()] - 1].csName, sizeof(name ));
                  CtpWsnC$csTable[sim_node()][CtpWsnC$j[sim_node()]].data = CtpWsnC$csTable[sim_node()][CtpWsnC$j[sim_node()] - 1].data;
                  CtpWsnC$csTable[sim_node()][CtpWsnC$j[sim_node()]].weight = CtpWsnC$csTable[sim_node()][CtpWsnC$j[sim_node()] - 1].weight;
                }
              memcpy(& CtpWsnC$csTable[sim_node()][0].csName, & CtpWsnC$send[sim_node()]->msgName, sizeof(name ));
              CtpWsnC$csTable[sim_node()][0].data = CtpWsnC$send[sim_node()]->data;
...
# 31 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Intercept.nc"
inline static bool /*CtpP.Forwarder*/CtpForwardingEngineP$0$Intercept$forward(collection_id_t arg_0x2abe1f9cc9b0, message_t * msg, void * payload, uint8_t len){
#line 31
  unsigned char __nesc_result;
#line 31

#line 31
    __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Intercept$default$forward(arg_0x2abe1f9cc9b0, msg, payload, len);
#line 31
...
# 78 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * /*CtpP.Forwarder*/CtpForwardingEngineP$0$Receive$receive(collection_id_t arg_0x2abe1f9cd270, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Receive$default$receive(arg_0x2abe1f9cd270, msg, payload, len);
#line 78
...
inline static uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$maxPayloadLength(am_id_t arg_0x2abe1f8c77d8){
#line 123
  unsigned char __nesc_result;
#line 123

#line 123
  __nesc_result = TossimActiveMessageC$AMSend$maxPayloadLength(arg_0x2abe1f8c77d8);
#line 123
...
# 78 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2abe1f4fe340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2abe1f4fe340) {
#line 78
    case 3:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2abe1f4fe340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 80 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2abe1f8c77d8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2abe1f8c77d8, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2abe1f4ff220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2abe1f4ff220, msg, error);
#line 110
}
#line 110
...
# 100 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static void /*CtpP.Forwarder*/CtpForwardingEngineP$0$Send$sendDone(uint8_t arg_0x2abe1f9ce108, message_t * msg, error_t error){
#line 100
    /*CtpP.Forwarder*/CtpForwardingEngineP$0$Send$default$sendDone(arg_0x2abe1f9ce108, msg, error);
#line 100
}
#line 100
...
# 78 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * /*CtpP.Forwarder*/CtpForwardingEngineP$0$Snoop$receive(collection_id_t arg_0x2abe1f9cde08, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*CtpP.Forwarder*/CtpForwardingEngineP$0$Snoop$default$receive(arg_0x2abe1f9cde08, msg, payload, len);
#line 78
...
# 78 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2abe1f4fd020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2abe1f4fd020) {
#line 78
    case 113:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2abe1f4fd020, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 75 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2abe1f20b108){
#line 75
  switch (arg_0x2abe1f20b108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2abe1f20b108);
#line 75
      break;
#line 75
    }
...
# 83 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2abe1fe57da0){
#line 83
  switch (arg_0x2abe1fe57da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2abe1fe57da0);
#line 83
      break;
#line 83
    }
...
# 100 "/home/cb/tinyos/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2abe1f8c85e8, message_t * msg, error_t error){
#line 100
  switch (arg_0x2abe1f8c85e8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2abe1f8c85e8, msg, error);
#line 100
      break;
#line 100
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "CtpWsnC$j"))
  {
    *addr = (uintptr_t)&CtpWsnC$j[__nesc_mote];
    *size = sizeof(CtpWsnC$j[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&CtpWsnC$j[__nesc_mote], 0, sizeof CtpWsnC$j[__nesc_mote]);
